                    ...
                    <aside className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-[#4a3728] rounded-xl p-6 text-white shadow-xl shadow-[#4a3728]/20 overflow-hidden relative">
                            ...
                            <button
                                ...
                                className="w-full py-3 bg-white text-[#4a3728] rounded-lg font-black text-xs uppercase tracking-widest hover:bg-[#faf7f0] transition-colors shadow-lg active:scale-95"
                            >
                                Start Assistant
                            </button>
                        </div>
